...
function setupAudio() {
  ...
  $('.poetry.control.repeat').on('touchstart', replayCurrent)
  $('.poetry.control.settings').on('click', toggleSettings)
  $('.poetry.control.settings').on('touchstart', toggleSettings)
  $('#toggleImages').on('click',toggleImages)
  $('#toggleImages').on('touchstart',toggleImages)
  $('#togglePlayer').on('click',togglePlayer)
  $('#togglePlayer').on('touchstart',togglePlayer)
